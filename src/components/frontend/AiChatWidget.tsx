...
const GREETING: Message = {
  role: 'assistant',
  content: '您好！我是鼎立 AI 客服 🏠 想幫您找到最適合的物件。\n\n請告訴我您的需求，例如：\n• 想找哪個地區？（台北市、新北市…）\n• 預算範圍？\n• 房型偏好？（套房／兩房／整層住家…）\n• 有特別需求嗎？（寵物、電梯、近捷運…）',
};

export default function AiChatWidget({ triggerClassName, triggerLabel = '🤖 鼎立 AI 客服' }: Props) {
          ...
          >
            ...
            <div className="bg-gradient-to-r from-brand-green-700 to-brand-green-900 text-white px-5 py-3.5 flex items-center justify-between flex-shrink-0">
              <div>
                ...
                <h3 className="font-extrabold">鼎立 AI 客服</h3>
              </div>
              <button
                type="button"
                onClick={() => setOpen(false)}
